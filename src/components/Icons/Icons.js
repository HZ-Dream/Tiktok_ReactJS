...
export const PrevIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        color="inherit"
...
export const PauseIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        <path d="M9 5H17V43H9V5Z" fill="#fff" />
        <path d="M31 5H39V43H31V5Z" fill="#fff" />
    </svg>
);
...
export const UpScrollIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        ...
        viewBox="0 0 24 24"
    >
        <path d="M12 2l6 6H13v8H11V8H6l6-6z" />
    </svg>
);

export const BreakHeartIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        ...
        viewBox="0 0 24 24"
    >
        <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35zM11 8l-3 4h4l-2 5 5-7h-4l2-5z" />
    </svg>
);
...
export const FlagIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        ...
        viewBox="0 0 24 24"
    >
        <path d="M4 2h16l-3 6 3 6H4v6H2V2h2z" />
    </svg>
);
